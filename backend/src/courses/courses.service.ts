        ...
        steps: [
          {
            ...
            bodyUk: [
              ...
              { type: 'p', text: 'Коли сигналізація спрацьовує, тіло за частку секунди готується до бою чи втечі. Серце починає битися швидше, женучи більше кисню до мʼязів; дихання прискорюється, мʼязи напружуються, долоні пітніють. Увага звужується на джерелі загрози — думати про щось інше стає важко. Усе це геніально доцільне перед реальною небезпекою (хижак, аварія) і рятувало життя тисячі років. Проблема лише в тому, що та сама буря піднімається й тоді, коли загрози немає, — і тоді вона просто виснажує.' },
            ...
            bodyEn: [
              ...
              { type: 'p', text: 'When the alarm fires, the body prepares to fight or flee in a fraction of a second. The heart beats faster, pushing more oxygen to the muscles; breathing speeds up, the muscles tense, the palms sweat. Attention narrows onto the source of threat — it becomes hard to think of anything else. All of this is brilliantly fitting before real danger (a predator, a crash) and has saved lives for thousands of years. The only problem is that the same storm rises when there is no threat — and then it simply exhausts.' },
          ...
          },
          {
            ...
            bodyUk: [
              ...
              { type: 'p', text: 'Подивися на коло на малюнку. Зʼявляється тригер — тривога росте — людина уникає або тікає — і відчуває миттєве полегшення. Це полегшення й є пасткою: мозок робить висновок «було небезпечно, добре що я втік», і страх перед цією ситуацією підкріплюється. Тому наступного разу тривога приходить ще раніше й сильніше, а коло ситуацій, які людина дозволяє собі, дедалі звужується. Так разове уникання поступово перетворюється на спосіб життя, обмежений страхом.' },
            ...
            bodyEn: [
              ...
              { type: 'figure', figure: 'anxiety-loop' },
              { type: 'p', text: 'Look at the circle in the figure. A trigger appears — anxiety rises — the person avoids or flees — and feels instant relief. That relief is the trap: the brain concludes "it was dangerous, good thing I fled", and the fear of this situation is reinforced. So next time anxiety comes even sooner and stronger, and the range of situations the person allows themselves keeps shrinking. This is how a one-off avoidance gradually turns into a way of life narrowed by fear.' },
        ...
        steps: [
          {
            ...
            bodyUk: [
              ...
              { type: 'p', text: 'Друга навичка — заземлення: вона перемикає увагу з «голови», де крутяться думки-катастрофи, на «тут і зараз» через органи чуття. Найвідоміший варіант — 5-4-3-2-1: назвати подумки або вголос пʼять речей, які бачиш, чотири звуки, які чуєш, три поверхні, яких торкаєшся, два запахи й один смак. Поки мозок зайнятий конкретними відчуттями, йому важче роздувати тривожний сценарій.' },
              ...
              { type: 'p', text: 'Навичку недостатньо описати словами — її треба прожити разом. Спершу поясни клієнту, навіщо вона й як працює (раціонал), щоб це не виглядало як порожнє «дихай і заспокойся». Потім покажи й зробіть разом тут-таки, у кабінеті. Далі дай клієнту спробувати самому, а ти спостерігай і мʼяко підкажи. І нарешті домовтеся про конкретну практику між сесіями — коли й де він пробуватиме. Навичка, яку не відпрацювали в кабінеті, рідко спрацьовує вдома.' },
            ...
            bodyEn: [
              ...
              { type: 'figure', figure: 'grounding' },
              { type: 'p', text: 'The second skill is grounding: it switches attention out of "the head", where catastrophe thoughts spin, and into the here and now through the senses. The best-known version is 5-4-3-2-1: name, silently or aloud, five things you see, four sounds you hear, three surfaces you touch, two smells and one taste. While the brain is busy with concrete sensations, it is harder for it to inflate the anxious scenario.' },
              ...
              { type: 'p', text: 'It is not enough to describe a skill in words — it has to be lived through together. First explain to the client why it helps and how it works (the rationale), so it does not look like an empty "just breathe and calm down". Then demonstrate and do it together right there, in the room. Next let the client try it themselves while you watch and gently coach. And finally agree on concrete practice between sessions — when and where they will try it. A skill not rehearsed in the room rarely works at home.' },
          ...
          },
          {
            ...
            bodyUk: [
              ...
              { type: 'p', text: 'Тривожне мислення має кілька впізнаваних пасток, і варто навчити клієнта їх помічати. Катастрофізація — це коли уява одразу стрибає до найгіршого сценарію. Читання думок — упевненість, що знаєш, що про тебе думають інші («усі вирішать, що я нікчема»). Чорно-біле мислення ділить світ на «ідеально» або «повний провал», без середини. А переоцінка ймовірності робить малоймовірне таким, що відчувається майже неминучим. Помітити пастку — уже половина справи: думка перестає бути «правдою» й стає просто думкою.' },
              { type: 'h', text: 'Перевірка думки (а не суперечка з нею)' },
              { type: 'p', text: 'Мета — не переконати клієнта, що він «неправий» (це лише посилює опір), а разом, із цікавістю, перевірити думку на реалістичність. Допомагає послідовність простих запитань: яка саме думка лякає? які є докази за неї, а які — проти? що найімовірніше станеться насправді, а не в найгіршому сценарії? а якщо найгірше таки станеться — як я з цим упораюсь? і нарешті: що б я сказав другові, який має таку саму думку? Останнє питання часто вмикає здоровий глузд, який до себе людина чомусь не застосовує.' },
              { type: 'dialogue', lines: [
            ...
            bodyEn: [
              ...
              { type: 'p', text: 'Anxious thinking has a few recognisable traps, and it is worth teaching the client to spot them. Catastrophising is when the imagination jumps straight to the worst case. Mind-reading is being certain you know what others think of you ("everyone will decide I\'m worthless"). Black-and-white thinking splits the world into "perfect" or "total failure", with no middle. And overestimating probability makes the unlikely feel almost inevitable. Spotting the trap is already half the work: the thought stops being "the truth" and becomes just a thought.' },
              { type: 'h', text: 'Testing a thought (not arguing with it)' },
              { type: 'p', text: 'The goal is not to convince the client they are "wrong" (that only feeds resistance) but to test the thought for realism together, with curiosity. A sequence of simple questions helps: what exactly is the frightening thought? what is the evidence for it, and what is against? what will most likely actually happen, rather than in the worst case? and if the worst does happen — how would I cope with it? And finally: what would I tell a friend who had this very thought? That last question often switches on the common sense a person somehow withholds from themselves.' },
              { type: 'dialogue', lines: [
        ...
        steps: [
          {
            ...
            bodyUk: [
              ...
              { type: 'p', text: 'Кілька принципів роблять експозицію дієвою. Поступовість: рухаються від легшого до важчого, хоч і не обовʼязково суворо по черзі. Мета — здивування, а не «перечекати»: лишатися треба достатньо, щоб побачити, що передбачене лихо не сталося, а не доки тривога впаде. Без «рятувальної» поведінки: важливо прибрати костурі на кшталт пляшки води «про всяк випадок» чи місця біля виходу — інакше клієнт припише безпеку їм, а не реальності. І повторюваність у різних контекстах: нове навчання міцніше, коли пробувати в різних місцях і станах, а не один раз в одному кабінеті.' },
              ...
              { type: 'h', text: 'Чого не робити' },
              { type: 'p', text: 'І чого варто уникати. Не штовхай клієнта в найстрашніше одразу й без його згоди — це лякає й руйнує довіру. Не вимагай, щоб тривога обовʼязково «впала», перш ніж завершити крок, — це повертає до застарілої моделі звикання. І не дозволяй рятувальну поведінку, яка насправді «рятує» клієнта саме від того, заради чого все робиться, — від перевірки передбачення.' },
            ...
            bodyEn: [
              ...
              { type: 'p', text: 'A few principles make exposure work. Gradual: move from easier to harder, though not necessarily in strict order. The goal is surprise, not "waiting it out": stay long enough to see that the predicted disaster did not happen, rather than until anxiety drops. No "safety" behaviour: it matters to drop the crutches — a "just-in-case" water bottle, a seat by the exit — otherwise the client credits safety to them, not to reality. And repeated, across contexts: new learning sticks better when practised in varied places and states, not once in a single room.' },
              ...
              { type: 'h', text: 'What not to do' },
              { type: 'p', text: "And what to avoid. Don't push the client into the scariest thing at once or without their consent — it frightens and breaks trust. Don't require anxiety to \"drop\" before ending the step — that reverts to the outdated habituation model. And don't allow safety behaviour that actually \"rescues\" the client from the very thing the exercise is for — testing the prediction." },
